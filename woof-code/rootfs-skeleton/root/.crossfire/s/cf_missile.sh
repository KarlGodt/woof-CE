...
# d   :debugging output
while getopts A:BC:D:W:LZdVhabdefgijklmnopqrstuvwxyzEFGHIJKMNOPQRSTUXY oneOPT
do
case $oneOPT in
...
# d   :debugging output
while getopts A:BC:D:W:LZdVhabdefgijklmnopqrstuvwxyzEFGHIJKMNPOQRSTUXY oneOPT
do
case $oneOPT in
A) ATTACKS_SPOT=$OPTARG;;
B) DO_BRACE=1;;
