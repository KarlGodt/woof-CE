...
# 2018-02-10
# cf_melee.sh :
# script to level up the skill SKILL_MELEE
...
VERSION=3.5 # require cf_funcs_items.sh
...
_draw_stdalone 10 "-A # :Number of attack attempts per spot."
_draw_stdalone 10 "-B : brace character."
_draw_stdalone 10 "-Z : turn anti-clockwise."
_draw_stdalone 9  "-c : train skill clawing."
_draw_stdalone 9  "-f : train skill flame touch."
_draw_stdalone 9  "-k : train skill karate."
_draw_stdalone 9  "-o : train skill one handed weapon."
_draw_stdalone 9  "-p : train skill punching."
_draw_stdalone 9  "-t : train skill two handed weapons."
...
_draw 10 "-A # :Number of attack attempts per spot."
_draw 10 "-B : brace character."
_draw 10 "-Z : turn anti-clockwise."
_draw 9  "-c : train skill clawing."
_draw 9  "-f : train skill flame touch."
_draw 9  "-k : train skill karate."
_draw 9  "-o : train skill one handed weapon."
_draw 9  "-p : train skill punching."
_draw 9  "-t : train skill two handed weapons."
...
_msg_stdalone 7 "__check_drawinfo_stdalone:$*"
...
_msg_stdalone 7 "__kill_monster_stdalone:$*"
...
_msg_stdalone 7 "___set_next_direction_stdalone:$*:$DIRN"
...
k) SKILL_MELEE='karate';;
o) SKILL_MELEE='one handed weapon';;
p) SKILL_MELEE=punching;;
t) SKILL_MELEE='two handed weapon';;
...
# brace and
# attack around
# with skill $SKILL_MELEE

_melee_around_stdalone(){
_msg_stdalone 7 "_melee_around_stdalone:$*"
...
_msg_stdalone 7 "_main_melee_stdalone:$*"
