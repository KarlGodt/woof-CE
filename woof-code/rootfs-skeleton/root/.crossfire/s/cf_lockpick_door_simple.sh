...
_draw_stdalone 7  "to disarm them,"
_draw_stdalone 7  "and to lockpick a door."
_draw_stdalone 2  "To be used in the crossfire roleplaying game client."
_draw_stdalone 6  "Syntax:"
_draw_stdalone 7  "script $0 <<Options>>"
...
_draw 7  "to disarm them,"
_draw 7  "and to lockpick a door."
