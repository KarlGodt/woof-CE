...
# S # :Singing attempts
# d   :debugging output
while getopts A:BC:O:S:D:ZdVhLabdefgijklmnopqrstuvwxyzEFGHIJKMNPQRTUWXY oneOPT
do
case $oneOPT in
...
_msg_stdalone 7 "_orate_to_monster_ready_skill_stdalone:$*"
_log_stdalone   "_orate_to_monster_ready_skill_stdalone:$*"
...
_msg_stdalone 7 "_sing_and_orate_around_stdalone:$*"
_log_stdalone   "_sing_and_orate_around_stdalone:$*"
...
_msg_stdalone 7 "_main_orate_stdalone:$*"
_log_stdalone   "_main_orate_stdalone:$*"
...
_debug "_main_orate_func:$*"
_log   "_main_orate_func:$*"
