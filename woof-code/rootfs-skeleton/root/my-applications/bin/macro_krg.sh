...
# $LANG=de_DE@euro
# today=Fr·28.·Okt·13:57:05·GMT+1·2011
#
#
#
#
...
# Linux
# puppypc
# 2.6.37.4-KRG-i486-StagingDrivers-2
# #4
# SMP
# Thu
# Mar
...
# 2007
# $LANG=de_DE@euro
# today=Fr·28.·Okt·13:55:25·GMT+1·2011
#
#
#
#
...
# $LANG=de_DE@euro
# today=Fr·28.·Okt·13:46:45·GMT+1·2011
# TODO1: X[org] server version
#
#
#
#
...
[ ! -e "$1" ] && help_func "$1 does not exist -- TYPO ?" ##+++2011_10_28 
[ -d "$1" ] && help_func "$1 is a directory"  ##+++2011_10_28
[ ! -f "$1" ] && help_func "file $1 is not a regular file -- TYPO ?"  ##+++2011_10_22
...
###+++2011_10_28 added Xorg -version part below
if [ "`echo $(basename $xServer) | grep -i 'xorg'`" != "" ] ;then
Xorg -version 2>/tmp/Xorg_version.txt
xServer=`cat /tmp/Xorg_version.txt | head -n 7 | sed '/^[[:blank:]]*$/d' | tr ' ' '·'`
fi
###+++2011_10_28 end of add part
