...
elif [ "$NUM" = "5" ];then rpl -q "$REPLACE" "WorkspaceNames = \" 1 \", \" 2 \", \" 3 \", \" 4 \", \" 5 \"" $HOME/.icewm/preferences
elif [ "$NUM" = "6" ];then rpl -q "$REPLACE" "WorkspaceNames = \" 1 \", \" 2 \", \" 3 \", \" 4 \", \" 5 \", \" 6 \"" $HOME/.icewm/preferences
elif [ "$NUM" = "7" ];then rpl -q "$REPLACE" "WorkspaceNames = \" 1 \", \" 2 \", \" 3 \", \" 4 \", \" 5 \", \" 6 \", \" 7 \"" $HOME/.icewm/preferences
elif [ "$NUM" = "8" ];then rpl -q "$REPLACE" "WorkspaceNames = \" 1 \", \" 2 \", \" 3 \", \" 4 \", \" 5 \", \" 6 \", \" 7\", \" 8 \"" $HOME/.icewm/preferences
        fi
}
...
STRING="${STRING%,*}"
echo "$STRING"
rpl -q "$REPLACE" "WorkspaceNames = $STRING" $HOME/.icewm/preferences
}
export -f DESKTOPS
...
for I in `seq 1 1 8`; do NUMBERS=`echo "$NUMBERS<item>$I</item>"`; done
