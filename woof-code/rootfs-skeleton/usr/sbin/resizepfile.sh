...
# 01.0 : chaged naming and content of pupsaveresize.txt
#
#
# /dev/hda7
# /dev/hda7:
...
# $LANG=en_US
# today=TueÂOctÂ25Â15:21:53ÂGMT+1Â2011
# TODO1 : make pupsaveresize.txt grepable and sedable
#         because pupsaveresize.$saveFile.txt name can become quite long
#
#
#
########################################################################
...
# needed to create a unique pupsaveresize.$saveFile.txt only for the particular
# savefile in question
##############################PUP_HOME='/mnt/dev_save'
#echo -n "$KILOBIG" > /initrd${PUP_HOME}/pupsaveresize.txt
echo -n "$KILOBIG,$pupSaveFile" > /initrd${PUP_HOME}${psubDir}/pupsaveresize.$saveFile.txt
