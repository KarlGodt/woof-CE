...
<frame Change Video Resolution and Language & Locale>
   <hbox width-request=\"600\">
    <vbox>
     <text width-request=\"560\"><label>\"Click here to change the video resolution, then Right-Click, Menu -> Shutdown -> Restart X server.\"</label></text>
    </vbox>
    <vbox>
  ...
  <hbox width-request=\"600\">
    <vbox>
     <text width-request=\"560\"><label>\"Click here to change the Language and Locale so that Puppy will speak your language\"</label></text>
    </vbox>
...
<frame Classic Configuration Experience>
   <hbox width-request=\"600\">
    <vbox>
     <text width-request=\"560\"><label>\"Click here to change Keyboard Layout, Timezone, and Video Driver.  The screen will blank so please save any work that is open.  The CCE and other programs to personalize Puppy are also available from the Desktop and Setup Menus and from the 'setup' icon on the desktop.\"</label></text>
    </vbox>
    <vbox>
  ...
  <frame Lupu Recommends>
   <hbox width-request=\"600\">
    <vbox>
     <text width-request=\"590\"><label>\"${DISPLAY_TEXT}\"</label></text>
    </vbox>
   </hbox>
  </frame>
 </vbox>
