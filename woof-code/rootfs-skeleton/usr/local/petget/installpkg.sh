...
#/tmp/PetGet/petget_missing_dbentries-Packages-* has database entries for the set of pkgs being downloaded.
#w456 warning: petget may write to /tmp/PetGet/petget_missing_dbentries-Packages-alien with missing fields.
 ...
 *.pet)
  ...
  BODY="${DLPKG_BASE//\.pet/}"
  tgz2pet "$DLPKG_PATH"/"$BODY".tar.gz
